...
if (el) {
  ReactDom.render(
    <Router basename={baseLocation}>
      <Route path="/" exact component={RouteList} />
      <Route path="/index.html" component={RouteList} />
      <Route
        path="/technical-analysis"
        render={() => (
          <AdvancedChart chartInitialized={chartInitialized} onChartReady={onChartReady} />
        )}
      />
      <Route path="/multi-chart" component={MultiChart} />
