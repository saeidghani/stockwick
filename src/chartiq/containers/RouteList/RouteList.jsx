    ...
    return (
      <span className="route-list">
        ...
        <p className="description">
          The chartiq-react-app project is a toolkit of React components. The following components
          create complete charting applications: (Select the component names to see the
          applications.)
        </p>
        ...
        <ul className="top-level">
          <li>
            ...
            <p>
              Creates a chart with a full-featured user interface. AdvancedChartComponent is the
              equivalent of ChartIQ's technical-analysis-chart.html advanced template.
            </p>
          </li>
          <li>
            <h3>
            ...
            <p>Displays two advanced chart components side by side in the same document.</p>
          </li>
          <li>
            <h3 className="disabled-link" style={{ color: '#888' }}>
              ActiveTraderWorkstation
              <div>
                <i>
                  Note: to activate above route search and uncomment 4 statements in the /src
                  directory following the <br />
            ...
            <p>Features the advanced chart component enhanced with the following plug-ins:</p>
            <ul>
